...
@Disabled
public class LcrHardwareOpModeSample extends LinearOpMode {
    private static final double DRIVE_SPEED = 0.5;
    private HardwareBobAlexanderIII robot = new HardwareBobAlexanderIII(this, DRIVE_SPEED);

    public void runOpMode() {
        robot.init(hardwareMap);

        // Things you can do:
        robot.moveMotor(robot.lifter, DRIVE_SPEED, 2); // Extend stronkboi for two seconds.
